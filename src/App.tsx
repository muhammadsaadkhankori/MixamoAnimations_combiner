...
async function combineAnimations (): Promise<void> {
  ...
  group.name = gltfName;
  gltf.scene.children[0].children[1].userData["gltfExtensions"] = {
    MOZ_hubs_components: { "morph-audio-feedback": { name: "mouthOpen", minValue: 0, maxValue: 4 } },
  };
  ...
  gltfExporter.parse(
    ...
    console.error,
    { binary: true, animations: group.animations, includeCustomExtensions: true }
  )
}
